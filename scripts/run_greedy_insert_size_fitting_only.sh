...
echo "Reading minimizer paths from: ${PATHS_JSONL}"
...
echo "Reading basepair paths from: ${RECONSTRUCTED_FA}"
...
INSERT_SIZE_BINS="0,100,200,400,600,800,1000,1600,3200,6400,12800"
# INSERT_SIZE_BINS="0,10,20,40,60,80,100,160,320,640,1280"
