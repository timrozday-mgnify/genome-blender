...
# COMBO_MAX_DISTANCE: maximum bp distance between R1 and R2 minimizers for PE combo.
...
# INSERT_SIZE_BINS: comma-separated bp bin edges — must span the expected insert size range.
